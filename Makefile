...
# Project:  libsbg.pro
# Template: lib
# Command: /usr/bin/qmake-qt5 -o Makefile libsbg.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DLIBSBG_LIBRARY -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
LINK          = g++
LFLAGS        = -Wl,-O1 -shared -Wl,-soname,liblibsbg.so.1
