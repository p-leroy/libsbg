#############################################################################
# Makefile for building: libsbg
# Generated by qmake (2.01a) (Qt 4.8.6) on: ven. 3. juin 08:01:11 2016
# Project:  libsbg.pro
# Template: lib
# Command: c:\Qt\4.8.6\bin\qmake.exe -spec c:\Qt\4.8.6\mkspecs\win32-msvc2010 CONFIG+=declarative_debug -o Makefile libsbg.pro
#############################################################################
...
Makefile: libsbg.pro  c:\Qt\4.8.6\mkspecs\win32-msvc2010\qmake.conf c:\Qt\4.8.6\mkspecs\qconfig.pri \
		...
		c:\Qt\4.8.6\mkspecs\features\dll.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.6\mkspecs\win32-msvc2010 CONFIG+=declarative_debug -o Makefile libsbg.pro
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) ".\libsbg.intermediate.manifest"
	-$(DEL_FILE) libsbg.exp
	-$(DEL_FILE) libsbg.ilk
	-$(DEL_FILE) vc*.pdb
	-$(DEL_FILE) vc*.idb
